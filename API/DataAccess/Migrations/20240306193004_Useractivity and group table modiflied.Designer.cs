...
namespace ExtremeClassified.DataAccess.Migrations
{
    ...
    [Migration("20240306193004_Useractivity and group table modiflied")]
    partial class Useractivityandgrouptablemodiflied
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExtremeClassified.Domain.Listing.ListingAlert", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ExtremeClassified.Domain.Identity.UserGroup", b =>
                {
                    b.HasOne("ExtremeClassified.Domain.Identity.Group", "Group")
                        .WithMany()
                        .HasForeignKey("KeyField")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ExtremeClassified.Domain.Portal.CountryAdministrativeDivision", b =>
                {
                    b.HasOne("ExtremeClassified.Domain.Portal.PortalCountry", "Country")
                        .WithMany("CataloCountryAdministrativeDivisiongueDetails")
            ...
            modelBuilder.Entity("ExtremeClassified.Domain.Portal.PortalCountry", b =>
                {
                    b.Navigation("CataloCountryAdministrativeDivisiongueDetails");
                });
