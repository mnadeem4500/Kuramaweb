...
namespace ExtremeClassified.WebApi.Functions
{
    public class UserFunctions
    {
        ...
        public List<UserDto> GetAll(bool onlyActive = true)
        {
            var bll = new BLL<User>(settings.ConnectionString);
            try
            {
        ...
        public UserDto GetAddress(string userId)
        {
            ...
            try
            {
                ...
                //var add = mapper.Map<UserAddress, Dtos.Identity.UserAddressDto>(entity);
                //return add;
            }
            catch (Exception ex)
            {
        ...
        public string AddAddress(Dtos.Account.UserAddressDto address)
        {
            var bll = new BLL<UserAddress>(settings.ConnectionString);
            try
            {
        ...
        public string UpdateAddress(Dtos.Account.UserAddressDto address)
        {
            var bll = new BLL<UserAddress>(settings.ConnectionString);
            try
            {
