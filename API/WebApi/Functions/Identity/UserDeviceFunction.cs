    ...
    public class UserDeviceFunction
    {
        ...
        public string Create(UserDeviceDto device)
        {
            ...
            try
            {
                ...
                userdevice.NameField = device.DeviceName;
                userdevice.Model = device.DeviceModel;
                userdevice.DeviceOs = device.DeviceOs;
                userdevice.Vender = device.DeviceVender;
                userdevice.FingerPrint = device.FingerPrint;
                userdevice.Active = device.Active;
                userdevice.CreationDate = device.CreationDate;
                gbll.Add(userdevice);
                return userdevice.NameField;
        ...
        public string Update(UserDeviceDto udevice)
        {
            ...
            try
            {
                ...
                devices.NameField = udevice.DeviceName;
